...
<head>
    ...
    <meta name="description" content="L'association "Octavius réunit cinq musiciens jouant dans différents styles musicaux tels que la musique classique, le jazz et la musique tzigane>
    ...
    <title><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Заголовок по умолчанию'; ?></title>
</head>
                    ...
                    <div class="upperMenu menu">
                        ...
                        <nav class="menuBody">
                            <ul class="menuList">
                                ...
                                <li><a href="contact.php" class="menuLink" id="lasMenuLink">Contactez-nous</a></li>
